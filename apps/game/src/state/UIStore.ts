...
export class UIStore {
  ...
  autospinRemaining = 0;
  /** Vortex ante ("lucky bet") active — every spin stakes more and guarantees a vortex. */
  vortexActive = false;
  ...
  setVortexActive(active: boolean): void {
