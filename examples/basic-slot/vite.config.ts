...
const coreAudioSrc = fileURLToPath(new URL('../../packages/core/src/audio/index.ts', import.meta.url));
const coreRulesSrc = fileURLToPath(new URL('../../packages/core/src/rules/index.ts', import.meta.url));
...
export default defineConfig(({ command }) => ({
  ...
  resolve: {
    ...
    ...(command === 'serve' ? { alias: { '@stakeplate/core/audio': coreAudioSrc, '@stakeplate/core/rules': coreRulesSrc, '@stakeplate/core': coreSrc } } : {}),
